 ...
 */
#ifndef DJINN_PWORLD_H
#define DJINN_PWORLD_H
...
namespace djinn {
     ...
     */
    class GroundContacts : public djinn::ParticleContactGenerator
    {
        djinn::ParticleWorld::Particles *particles;

    public:
        void init(djinn::ParticleWorld::Particles *particles);

        virtual unsigned addContact(djinn::ParticleContact *contact,
            unsigned limit) const;
    };

} // namespace djinn

#endif // DJINN_PWORLD_H
